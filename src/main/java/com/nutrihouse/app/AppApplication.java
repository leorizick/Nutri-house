...
public class AppApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido ped1 = new Pedido(null, cli1, LocalDateTime.now());
		Pedido ped2 = new Pedido(null, cli2, LocalDateTime.now());
		Pedido ped3 = new Pedido(null, cli1, LocalDateTime.now());
